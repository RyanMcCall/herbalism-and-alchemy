...
shorthand_ref = {
    ...
    "df": drakus_flower,
    "de": dried_ephedra,
    "ewat": elemental_water,
    "ewax": emetic_wax,
    "fsi": fennel_silk,
    "fi": fiends_ivy,
    "fse": frozen_seedlings,
    "gb": gengko_brush,
    "hl": harrada_leaf,
    "hn": hyancinth_nectar,
    "h": hydrathistle,
    "ih": ironwood_heart,
    "ls": lavender_sprig,
    "lcd": luminous_cap_dust,
    "mr": mandrake_root,
    "ms": milkweed_seeds,
    "mp": mortflesh_powder,
    "nb": nightshade_berries,
    "pb": primordial_balm,
    "ql": quicksilver_lichen,
    "rs": radiant_synthseed,
    "rv": rock_vine,
    "sbea": scillia_beans,
    "sh": silver_hibiscus,
    "sber": spineflower_berries,
    "tl": tail_leaf,
    "vn": verdant_nettle,
    "v": voidroot,
    "wsa": wild_sageroot,
